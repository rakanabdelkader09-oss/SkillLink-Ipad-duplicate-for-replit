...
const COURSES: OrigamiCourse[] = [
  {
    ...
    steps: [
      ...
      { title: 'Fold bottom strips up', description: 'Fold the bottom strip up on both sides.', youtubeId: 'a6V09L6OZwc', thumbnail: 'https://img.youtube.com/vi/a6V09L6OZwc/mqdefault.jpg' },
      { title: 'Open and shape', description: 'Open the bottom and press corners together to form the boat.', youtubeId: 'a6V09L6OZwc', thumbnail: 'https://img.youtube.com/vi/a6V09L6OZwc/mqdefault.jpg' },
    ],
  },
  {
    id: 'paper-airplane',
    ...
    steps: [
      ...
      { title: 'Fold sides inward', description: 'Fold the slanted edges to the center again.', youtubeId: '7Cy3lRJGiR4', thumbnail: 'https://img.youtube.com/vi/7Cy3lRJGiR4/mqdefault.jpg' },
      { title: 'Form wings', description: 'Fold both sides down to create the wings.', youtubeId: '7Cy3lRJGiR4', thumbnail: 'https://img.youtube.com/vi/7Cy3lRJGiR4/mqdefault.jpg' },
      { title: 'Fly!', description: 'Open the wings and test your plane!', youtubeId: '7Cy3lRJGiR4', thumbnail: 'https://img.youtube.com/vi/7Cy3lRJGiR4/mqdefault.jpg' },
    ],
  },
  {
    id: 'paper-cup',
    ...
    points: 20,
    steps: [
      { title: 'Fold diagonally', description: 'Fold the square paper diagonally to make a triangle.', youtubeId: 'z4IOOLCAwFI', thumbnail: 'https://img.youtube.com/vi/z4IOOLCAwFI/mqdefault.jpg' },
      { title: 'Fold right corner', description: 'Fold the right corner to the left edge.', youtubeId: 'z4IOOLCAwFI', thumbnail: 'https://img.youtube.com/vi/z4IOOLCAwFI/mqdefault.jpg' },
      { title: 'Fold left corner', description: 'Fold the left corner to the right edge.', youtubeId: 'z4IOOLCAwFI', thumbnail: 'https://img.youtube.com/vi/z4IOOLCAwFI/mqdefault.jpg' },
      { title: 'Fold top flaps', description: 'Fold down the front flap, flip and fold the back flap.', youtubeId: 'z4IOOLCAwFI', thumbnail: 'https://img.youtube.com/vi/z4IOOLCAwFI/mqdefault.jpg' },
      { title: 'Open the cup', description: 'Push your fingers inside and open the cup shape.', youtubeId: 'z4IOOLCAwFI', thumbnail: 'https://img.youtube.com/vi/z4IOOLCAwFI/mqdefault.jpg' },
    ],
  },
  {
    id: 'origami-crane',
    ...
    points: 35,
    steps: [
      { title: 'Start with square base', description: 'Fold your square paper into the preliminary base.', youtubeId: 'GC_Szxdqh2Y', thumbnail: 'https://img.youtube.com/vi/GC_Szxdqh2Y/mqdefault.jpg' },
      { title: 'Petal fold', description: 'Perform the petal fold on the front and back.', youtubeId: 'GC_Szxdqh2Y', thumbnail: 'https://img.youtube.com/vi/GC_Szxdqh2Y/mqdefault.jpg' },
      { title: 'Form the body', description: 'Fold the sides inward to narrow the body.', youtubeId: 'GC_Szxdqh2Y', thumbnail: 'https://img.youtube.com/vi/GC_Szxdqh2Y/mqdefault.jpg' },
      { title: 'Shape the neck and tail', description: 'Fold one point up for the neck, the other for the tail.', youtubeId: 'GC_Szxdqh2Y', thumbnail: 'https://img.youtube.com/vi/GC_Szxdqh2Y/mqdefault.jpg' },
      { title: 'Fold the head', description: 'Inside-reverse fold the top of the neck to make the head.', youtubeId: 'GC_Szxdqh2Y', thumbnail: 'https://img.youtube.com/vi/GC_Szxdqh2Y/mqdefault.jpg' },
      { title: 'Open the wings', description: 'Gently pull the wings apart and puff the body.', youtubeId: 'GC_Szxdqh2Y', thumbnail: 'https://img.youtube.com/vi/GC_Szxdqh2Y/mqdefault.jpg' },
    ],
  },
  {
    id: 'origami-frog',
  ...
  },
  {
    ...
    locked: true,
    steps: [
      { title: 'Bird base', description: 'Start with an advanced bird base fold.', youtubeId: '_q1qKtGTGgo', thumbnail: 'https://img.youtube.com/vi/_q1qKtGTGgo/mqdefault.jpg' },
      { title: 'Shape the body', description: 'Narrow and shape the body of the dragon.', youtubeId: '_q1qKtGTGgo', thumbnail: 'https://img.youtube.com/vi/_q1qKtGTGgo/mqdefault.jpg' },
      { title: 'Form the wings', description: 'Open and shape both wings.', youtubeId: '_q1qKtGTGgo', thumbnail: 'https://img.youtube.com/vi/_q1qKtGTGgo/mqdefault.jpg' },
      { title: 'Shape head and tail', description: 'Use reverse folds for the head and curved tail.', youtubeId: '_q1qKtGTGgo', thumbnail: 'https://img.youtube.com/vi/_q1qKtGTGgo/mqdefault.jpg' },
      { title: 'Final details', description: 'Curl the wings and tail for final polish.', youtubeId: '_q1qKtGTGgo', thumbnail: 'https://img.youtube.com/vi/_q1qKtGTGgo/mqdefault.jpg' },
    ],
  },
  {
    id: 'origami-rose',
    ...
    locked: true,
    steps: [
      { title: 'Waterbomb base', description: 'Fold a waterbomb base from your square sheet.', youtubeId: 'BATWfPjr3MI', thumbnail: 'https://img.youtube.com/vi/BATWfPjr3MI/mqdefault.jpg' },
      { title: 'Twist method', description: 'Apply the twist fold technique.', youtubeId: 'BATWfPjr3MI', thumbnail: 'https://img.youtube.com/vi/BATWfPjr3MI/mqdefault.jpg' },
      { title: 'Shape petals', description: 'Open and curve each petal outward.', youtubeId: 'BATWfPjr3MI', thumbnail: 'https://img.youtube.com/vi/BATWfPjr3MI/mqdefault.jpg' },
      { title: 'Form the base', description: 'Fold and lock the stem/base section.', youtubeId: 'BATWfPjr3MI', thumbnail: 'https://img.youtube.com/vi/BATWfPjr3MI/mqdefault.jpg' },
      { title: 'Final shaping', description: 'Gently open outer petals for a full bloom.', youtubeId: 'BATWfPjr3MI', thumbnail: 'https://img.youtube.com/vi/BATWfPjr3MI/mqdefault.jpg' },
    ],
  },
];
...
function YouTubePlayer({ youtubeId }: { youtubeId: string }) {
  return (
    <div className="relative w-full bg-black cursor-pointer" style={{ aspectRatio: '16/9' }} onClick={() => { Browser.open({ url: 'https://www.youtube.com/watch?v=' + youtubeId }); }}>
      <img src={'https://img.youtube.com/vi/' + youtubeId + '/mqdefault.jpg'} alt="Video thumbnail" className="absolute inset-0 w-full h-full object-cover opacity-80" />
